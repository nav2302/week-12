 ...
 * TO USE SWAGGER APIS
 * 
 * localhost:8891/swagger-ui.html
 */

@SpringBootApplication
@Slf4j
public class OfflineMicroServiceApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(OfflineMicroServiceApplication.class, args);
	}
